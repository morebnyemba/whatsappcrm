...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # Uses bind mount in docker-compose.yml for nginx access
...
LOGGING = {
    ...
    'loggers': {
        ...
        'football_data_app': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},
        'football_data_app.tasks': {'level': 'DEBUG', 'propagate': True},
        'football_data_app.tasks_apifootball': {'level': 'DEBUG', 'propagate': True},
        'football_data_app.apifootball_client': {'level': 'DEBUG', 'propagate': True},
        'football_data_app.api_football_v3_client': {'level': 'DEBUG', 'propagate': True},
        'football_data_app.the_odds_api_client': {'level': 'DEBUG', 'propagate': True},
    },
}

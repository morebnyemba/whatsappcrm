...
THE_ODDS_API_DEFAULT_MARKETS = "h2h,totals,spreads"  # Comma-separated list of markets
...
THE_ODDS_API_LEAD_TIME_DAYS = 10  # How many days in advance to start fetching odds for general upcoming events
THE_ODDS_API_UPCOMING_STALENESS_MINUTES = 60  # Frequency (in mins) to update odds for general upcoming events
THE_ODDS_API_IMMINENT_STALENESS_MINUTES = 15  # Frequency (in mins) to update odds for imminently starting events

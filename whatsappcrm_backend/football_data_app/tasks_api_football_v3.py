...
# API-Football v3 Bet Type IDs
# Per API-Football v3 documentation: https://www.api-football.com/documentation-v3#tag/Odds
# bet_id 6 is reserved but not commonly documented or used
API_FOOTBALL_BET_IDS = [1, 2, 3, 4, 5, 7, 8, 9]
# 1: Match Winner (1X2), 2: Double Chance, 3: Asian Handicap, 4: Draw No Bet,

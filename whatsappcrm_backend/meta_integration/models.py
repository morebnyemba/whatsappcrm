...
class MetaAppConfig(models.Model):
    ...
    flow_private_key_pem = models.TextField(
        blank=True,
        null=True,
        help_text="PEM-encoded RSA private key for WhatsApp Flows encryption/decryption. "
                  "Generated by the setup_flow_encryption management command."
    )

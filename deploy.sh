...
ask SESSION_TIMEOUT_MINUTES "WhatsApp login (auth) session idle timeout (minutes)" "5" v_int
...
ENV_KEYS=(DJANGO_SECRET_KEY DJANGO_DEBUG DJANGO_ALLOWED_HOSTS CSRF_TRUSTED_ORIGINS SITE_URL
  ...
  JWT_ACCESS_TOKEN_LIFETIME_MINUTES JWT_REFRESH_TOKEN_LIFETIME_DAYS SESSION_IDLE_TIMEOUT_MINUTES SESSION_TIMEOUT_MINUTES CONVERSATION_EXPIRY_DAYS
